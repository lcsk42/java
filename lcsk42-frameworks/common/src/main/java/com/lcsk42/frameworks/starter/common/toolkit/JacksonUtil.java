package com.lcsk42.frameworks.starter.common.toolkit;
...
public final class JacksonUtil {
    ...
    static {
        ...
        // Convert Long values to strings to avoid JavaScript number precision issues
     ...
     * @throws ServiceException if deserialization fails
     */
    public static <T> T to(String json,
     ...
     * @throws ServiceException if serialization fails
     */
    public static <T> String toPrettyPrinter(T object) {
        if (Objects.isNull(object)) {
            return null;
        }
        try {
