...
public class FtpFileService implements FileService {
    ...
    public FtpFileService(FileUploadProperties properties) {
        this.properties = properties;
    }

    @Override
    public FileService of(FileUploadProperties properties) {
        return new FtpFileService(properties);
    }

    @Override
    public FileUploadType getFileUploadType() {
        return FileUploadType.FTP;
    }
    ...
    public void renameFile(String oldKey, String newFileName, String bucketName) {
        ...
        try {
            ...
            throw new ServiceException("Failed to rename file: %s/%s".formatted(bucketName, oldKey));
        }
    }
